...
class AppConfig:
    ...
    METRICS_API_KEY: str = ""
    MERCADOPAGO_ACCESS_TOKEN: str = "APP_USR-2371517644563796-112514-ad65181a370bee892545acadcbe1b742-3016023353"
    MERCADOPAGO_PUBLIC_KEY: str = "APP_USR-fc3fd236-6774-45c1-914b-fae98be43bc5"
    ...
    def from_env(cls, env: Optional[Env] = None) -> "AppConfig":
        ...
        return cls(
            ...
            MERCADOPAGO_ACCESS_TOKEN=env.get("MERCADOPAGO_ACCESS_TOKEN", cls.MERCADOPAGO_ACCESS_TOKEN),
            MERCADOPAGO_PUBLIC_KEY=env.get("MERCADOPAGO_PUBLIC_KEY", cls.MERCADOPAGO_PUBLIC_KEY),
            MERCADOPAGO_NOTIFICATION_URL=env.get("MERCADOPAGO_NOTIFICATION_URL", cls.MERCADOPAGO_NOTIFICATION_URL),
